...
<body class="logado">
    <nav class="navbar navbar-expand-lg " aria-label="Eighth navbar example">
        <div class="container">
            <a class="navbar-brand" href="#">Guia de Bolso</a>
            ...
            <div class="navbar-nav ml-auto">
                <div class="nav-item dropdown show">
                    <a href="#" data-toggle="dropdown" class="nav-link  user-action" aria-expanded="true"><img src="./img/user.jfif" class="text-light" alt="Avatar"> <?php echo $nome ?></a>
                </div>
            </div>
    ...
    <div class="container recepcao">
        ...
        <header>
            <h1 class="text-center">Suas atividades</h1>
        </header>
        <form method="POST" action="./scripts/novatransacao.php">
            <div class="" style="width: 100%; margin-bottom:8px ;">
                <div class="">
                    <h5 class="card-title">Insira uma nova transação</h5>
                    <p class="card-text">
                    <div class="row">
                        <div class="col">
                            <input class="form-control" required id="descricao" name="descricao" type="text" placeholder="Descrição">
                        </div>
                        <div class="col">

                            <div class="input-group">
                                <i class="fa-solid fa-dollar-sign"></i>
                                <input class="form-control" required id="valor" name="valor" type="number" step="0.01" placeholder="Valor">
                            </div>
                        ...
                        <div class="col">
                            <button class="btn-plus btn-link p-0" type="submit">
